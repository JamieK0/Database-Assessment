        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
          ...
          <div class="u-carousel-inner" role="listbox">
            <div class="u-carousel-item u-form-step u-slide u-active">
              <div class="u-form-group u-form-name u-form-partition-factor-2" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div class="u-form-group u-form-partition-factor-2 u-form-group-2" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div class="u-form-email u-form-group" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;" >
              ...
              <div class="u-form-date u-form-group u-form-partition-factor-3 u-form-group-4" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div
                class="u-form-group u-form-number u-form-number-layout-number u-form-partition-factor-3 u-form-group-5" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div class="u-form-group u-form-partition-factor-3 u-form-select u-form-group-6" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div class="u-form-group u-form-partition-factor-2 u-form-group-7" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="text-d46f" class="u-label">PC Class</label>
                <input type="text" placeholder="" value="<?php echo $StuPC; ?>" name="StuPC"
                  class="u-input u-input-rectangle">
              </div>
              <div class="u-form-group u-form-partition-factor-2 u-form-group-8" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div class="u-form-group u-form-partition-factor-2 u-form-group-9" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="text-5181" class="u-label">Parent 1 First Name</label>
                <input type="text" placeholder="" id="text-5181" name="text" class="u-input u-input-rectangle">
              </div>
              <div class="u-form-group u-form-partition-factor-2 u-form-group-10" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="text-c3c2" class="u-label">Parent 2 First Name</label>
                <input type="text" placeholder="" id="text-c3c2" name="text-3" class="u-input u-input-rectangle">
              </div>
              <div class="u-form-group u-form-partition-factor-2 u-form-group-11" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="text-b533" class="u-label">Parent 1 Last Name</label>
                <input type="text" placeholder="" id="text-b533" name="text-4" class="u-input u-input-rectangle">
              </div>
              <div class="u-form-group u-form-partition-factor-2 u-form-group-12" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="text-40f6" class="u-label">Parent 2 Last Name</label>
                <input type="text" placeholder="" id="text-40f6" name="text-5" class="u-input u-input-rectangle">
              </div>
              <div class="u-form-group u-form-partition-factor-2 u-form-group-13" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="text-9af3" class="u-label">Home Address</label>
                <input type="text" placeholder="" id="text-9af3" name="text-1" class="u-input u-input-rectangle">
              </div>
              <div class="u-form-group u-form-partition-factor-2 u-form-group-14" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="text-6c73" class="u-label">Home Address (Secondary)</label>
                <input type="text" placeholder="" id="text-6c73" name="text-2" class="u-input u-input-rectangle">
              </div>
              <div class="u-form-group u-form-partition-factor-2 u-form-phone u-form-group-15" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="phone-c448" class="u-label">Parent 1 Mobile Phone</label>
                <input type="tel"
                  pattern="\+?\d{0,3}[\s\(\-]?([0-9]{2,3})[\s\)\-]?([\s\-]?)([0-9]{3})[\s\-]?([0-9]{2})[\s\-]?([0-9]{2})"
                  placeholder="Enter your phone (e.g. +14155552675)" id="phone-c448" name="phone"
                  class="u-input u-input-rectangle">
              </div>
              <div class="u-form-group u-form-partition-factor-2 u-form-phone u-form-group-16" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="phone-dd1c" class="u-label">Parent 2 Mobile Phone</label>
                <input type="tel"
                  pattern="\+?\d{0,3}[\s\(\-]?([0-9]{2,3})[\s\)\-]?([\s\-]?)([0-9]{3})[\s\-]?([0-9]{2})[\s\-]?([0-9]{2})"
                  placeholder="Enter your phone (e.g. +14155552675)" id="phone-dd1c" name="phone-1"
                  class="u-input u-input-rectangle">
              </div>
              <div class="u-form-group u-form-partition-factor-2 u-form-phone u-form-group-17" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="phone-11a2" class="u-label">Parent 1 Work Phone</label>
                <input type="tel"
                  pattern="\+?\d{0,3}[\s\(\-]?([0-9]{2,3})[\s\)\-]?([\s\-]?)([0-9]{3})[\s\-]?([0-9]{2})[\s\-]?([0-9]{2})"
                  placeholder="Enter your phone (e.g. +14155552675)" id="phone-11a2" name="phone-2"
                  class="u-input u-input-rectangle">
              </div>
              <div class="u-form-group u-form-partition-factor-2 u-form-phone u-form-group-18" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="phone-1927" class="u-label">Parent 2 Work Phone</label>
                <input type="tel"
                  pattern="\+?\d{0,3}[\s\(\-]?([0-9]{2,3})[\s\)\-]?([\s\-]?)([0-9]{3})[\s\-]?([0-9]{2})[\s\-]?([0-9]{2})"
                  placeholder="Enter your phone (e.g. +14155552675)" id="phone-1927" name="phone-3"
                  class="u-input u-input-rectangle">
              </div>
              <div class="u-form-group u-form-partition-factor-2 u-form-phone u-form-group-19" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="phone-1531" class="u-label">Home Phone</label>
                <input type="tel"
                  pattern="\+?\d{0,3}[\s\(\-]?([0-9]{2,3})[\s\)\-]?([\s\-]?)([0-9]{3})[\s\-]?([0-9]{2})[\s\-]?([0-9]{2})"
                  placeholder="Enter your phone (e.g. +14155552675)" id="phone-1531" name="phone-4"
                  class="u-input u-input-rectangle">
              </div>
              <div class="u-form-group u-form-partition-factor-2 u-form-phone u-form-group-20" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                <label for="phone-9df4" class="u-label">Home Phone (Secondary)</label>
                <input type="tel"
                  pattern="\+?\d{0,3}[\s\(\-]?([0-9]{2,3})[\s\)\-]?([\s\-]?)([0-9]{3})[\s\-]?([0-9]{2})[\s\-]?([0-9]{2})"
                  placeholder="Enter your phone (e.g. +14155552675)" id="phone-9df4" name="phone-5"
                  class="u-input u-input-rectangle">
              </div>
            </div>
            <div class="u-carousel-item u-form-step u-slide">
              <div class="u-form-group u-form-group-21" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div class="u-form-group u-form-group-22" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div class="u-form-group u-form-group-23" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div class="u-form-group u-form-group-24" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div class="u-form-group u-form-group-25" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div class="u-form-group u-form-group-26" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div class="u-form-group u-form-partition-factor-2 u-form-group-27" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
              ...
              <div class="u-form-group u-form-partition-factor-2 u-form-group-28" style="text-align:left; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
